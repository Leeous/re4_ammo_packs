...
function ENT:SpawnFunction(ply, trace)
    ...
    local ent = ents.Create( "tmp_ammo" )
...
function ENT:Initialize()
    self:SetModel("models/lee/props/re4_props/re4_ammo_pack_tmp.mdl")
...
function ENT:Use( ply, trace )
    ...
    ply:GiveAmmo(GetConVar("re4_tmp_ammo_amount"):GetInt(), GetConVar("re4_tmp_ammo_type"):GetString(), not GetConVar("re4_show_ammo_pickup"):GetBool())
    self:Remove();
end
...
function ENT:Touch(ply)
    ...
    self:EmitSound(pickup_sound)
    ply:GiveAmmo(GetConVar("re4_tmp_ammo_amount"):GetInt(), GetConVar("re4_tmp_ammo_type"):GetString(), not GetConVar("re4_show_ammo_pickup"):GetBool())
    print(GetConVar("re4_show_ammo_pickup"):GetBool())
    self:Remove()
end
